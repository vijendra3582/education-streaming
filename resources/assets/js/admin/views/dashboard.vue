        ...
        <div class="dashboard">
            ...
            <div class="white users-chart" v-if="chart_type === 1">
                    ...
                    <div class="col-6">
                        <div class="button-section float-right mt-3 ml-5">
                            <button class="btn btn-sm btn-warning ml-1"
                                    ...
                                    @click="users_analysis_active = 'day'">{{$t('dashboard.day')}}
                            </button>
                            <button class="btn btn-sm btn-warning ml-1"
                                    :class="{active: users_analysis_active === 'month'}"
                                    @click="users_analysis_active = 'month'">{{$t('dashboard.month')}}
                            </button>
                            <button class="btn btn-sm btn-warning ml-1"
                                    :class="{active: users_analysis_active === 'year'}"
                                    @click="users_analysis_active = 'year'">{{$t('dashboard.year')}}
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-12 row" v-if="chart_type === 1 && users_analysis_active == 'day'">
                    <div class="col-12 col-sm-6 col-lg-6">
                        ...
                        <div class="col-12 m-2 details">
                            <span class="header">{{$t('dashboard.active_user')}}</span>
                    ...
                    <div class="col-12 col-sm-6 col-lg-6">
                        ...
                        <div class="col-12 m-2 details">
                            <span class="header">{{$t('inactive_user')}}</span>
                ...
                <div class="col-12 row" v-if="chart_type === 1 && users_analysis_active == 'month'">
                    ...
                    <div class="col-12 col-sm-6 col-lg-6">
                        ...
                        <div class="col-12 m-2 details">
                            <span class="header">{{$t('dashboard.inactive_user')}}</span>
            ...
            <div class="white top-chart" v-if="chart_type === 2">
                    ...
                    <div class="col-6">
                        <div class="button-section float-right mt-3 ml-5">
                            <button class="btn btn-sm btn-warning ml-1" :class="{active: top_analysis_active === 'day'}"
                                    @click="top_analysis_active = 'day'">{{$t('dashboard.day')}}
                            </button>
                            <button class="btn btn-sm btn-warning ml-1"
                                    :class="{active: top_analysis_active === 'month'}"
                                    @click="top_analysis_active = 'month'">{{$t('dashboard.month')}}
                            </button>
                            <button class="btn btn-sm btn-warning ml-1"
                                    :class="{active: top_analysis_active === 'year'}"
                                    @click="top_analysis_active = 'year'">{{$t('dashboard.year')}}
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-12 row" v-if="chart_type ===2 && top_analysis_active == 'year'">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12 m-2 details">
                            <span class="header">{{$t('dashboard.most_watch')}}</span>
            ...
            <div class="white col-12 " v-if="chart_type === 3">
                ...
                <div class="col-12">
                    ...
                    <div class="col-12 m-2 details">
                        <span class="header">{{$t('dashboard.regions')}} {{$t('dashboard.users')}}</span>
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-2 mt-2 m-md-2 white card">
                        <div class="details">
                           <img src="/themes/default/img/admin/report.svg" alt="report" width="60px">
                            ...
                            <span class="header">{{$t('dashboard.reports')}}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-2 mt-2 m-md-2 white card">
                        <div class="details">
                          <img src="/themes/default/img/admin/movie.svg" alt="report" width="60px">
                            ...
                            <span class="header">{{$t('dashboard.single_video')}}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-2 mt-2 m-md-2 white card">
                        <div class="details">
                           <img src="/themes/default/img/admin/series.svg" alt="series" width="60px">
                            ...
                            <span class="header">{{$t('dashboard.courses')}}</span>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 col-lg-2 mt-2 m-md-2 white card">
                        <div class="details">
                            ...
                            <span class="header">{{$t('dashboard.live_seminar')}}</span>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 col-lg-2 mt-2 m-md-2 white card">
                        <div class="details">
                            ...
                            <span class="header">{{$t('dashboard.users')}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 offset-1 top">
                <div class="row">
                    <div class="col-12 col-md-3 white m-2" v-if="top_all_time.users !== []">
                        <b class="title ml-3">{{$t('dashboard.top_users')}}</b>
                    ...
                    <div class="col-12 col-md-3 white m-2" v-if="top_all_time.movies !== []">
                        <b class="title ml-3">{{$t('dashboard.top_single_video')}}</b>
                        <ul class="list-group mt-2">
                            <li class="list-group-item d-flex justify-content-between align-items-center"
                    ...
                    <div class="col-12 col-md-4 white m-2" v-if="top_all_time.series !== []">
                        <b class="title ml-3">{{$t('dashboard.top_courses')}}</b>
                        <ul class="list-group mt-2">
                            <li class="list-group-item d-flex justify-content-between align-items-center"
