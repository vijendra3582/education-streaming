        ...
        <div class="m-2" id="manage-panel">
            ...
            <div class="float-left mt-3" v-if="showGroupButton">
                <div class="button-group">
                    <button class="btn btn-sm btn-warning"  @click="AVAILABLE_IT()">{{$t('single_video.avail_unavail')}}</button>
                    <button class="btn btn-sm btn-warning" @click="DELETE()">{{$t('single_video.delete')}}</button>
                </div>
            </div>
            <ul class="nav nav-tabs">
                <li class="col col-md-4 offset-md-8">
                    <div id="search">
                        <input class="form-control mr-sm-2" type="text" v-model="query" v-bind:placeholder="$t('single_video.search')" @keyup="SEARCH">
                        </div>
                </li>
            </ul>
        </div>
                    ...
                    <div class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in data_search.movies" :key="index">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <router-link class="btn btn-sm btn-warning btn-sm mr-2" :to="{name:'analysis-single', params: {id:item.id}}" role="button">Analysis
                                        </router-link>
                                        ...
                                        <router-link class="btn btn-sm btn-warning btn-sm mr-2" :to="{name:'single_edit', params: {id:item.id}}" role="button">Edit
                                        </router-link>
                                    </div>
                                </td>
                            </tr>
