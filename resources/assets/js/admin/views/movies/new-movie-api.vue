<template>
   <div>
      <div class="k1_manage_table">
         <div class="title p-2">{{$t('single_video.api_upload')}}</div>
         <div class="col-12">
            <div class="row">
               <div class="col-12 col-lg-6">
                  ...
                  <div v-if="cloud_type">
                     <div class="form-group">
                        <div class="col-12">
                           <label>{{$t('single_video.video_id')}}</label>
                        </div>
                        <div class="col-12">
                           <input class="form-control" name="id" v-model="id" v-validate="'required|numeric'"
                              type="text" v-bind:placeholder="$t('single_video.video_id')"/>
                           <span v-show="errors.has('id')" class="is-danger">{{ errors.first('id') }}</span>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="col-12">
                           <label for="age">{{$t('single_video.choose_way_upload')}}</label>
                     ...
                     <transition name="menu-popover">
                        <div class="transcoding-section" v-show="upload_type_is == 'transcoding' ">
                           ...
                           <div class="form-group" v-if="upload_type_is == 'transcoding'">
                              <div class="col-12">
                                 <label for="presets">{{$t('single_video.select_preset')}}</label>
            ...
            <div class="form-group" v-if="cloud_type">
               <div class="col-12">
                  <button class="btn btn-md btn-warning" v-if="!disabled_button" @click="MOVIEDB_API(id)">{{$t('single_video.upload')}}
                  </button>
                  <button class="btn btn-md btn-warning" v-if="disabled_button" disabled>{{$t('single_video.loading')}}</button>
               </div>
            </div>
         </div>
      </div>
