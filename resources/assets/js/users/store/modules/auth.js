                    ...
                    axios
                        ...
                        .then(check => {
                            ...
                            if (check.data.status === 'payment_reactive') {
                                ...
                                Vue.auth.setToken(response.data.access_token, response.data.expires_in, check.data.name, check.data.email, check.data.language, 'payment_reactive');
                                router.go('/');
                                ...
                                Vue.auth.setToken(response.data.access_token, response.data.expires_in, check.data.name, check.data.email, check.data.language, 'cancel');
                                router.go('/');

                            } else if (check.data.status === 'payment_step') {


                                Vue.auth.setToken(response.data.access_token, response.data.expires_in, check.data.name, check.data.email, check.data.language, 'payment_step');
                                router.go('/');
