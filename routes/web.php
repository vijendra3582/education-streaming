...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    //Genres
    Route::get('/api/admin/get/genres', 'Admin\GenresController@getGenresBySort');

    //Rating System
    Route::get('/api/admin/get/ratingSystems', 'Admin\RatingSystemController@getRatingSystemBySort');
